...
def args_mgt(file_path= None):
    ...
    args_copy = fn_bootstrap(_fn_arg_defaults, demo_dot_path, demo_file_name, demo_folder_path)

    return args_copy


def fn_bootstrap(_fn_arg_defaults, demo_dot_path, demo_file_name, demo_folder_path):
