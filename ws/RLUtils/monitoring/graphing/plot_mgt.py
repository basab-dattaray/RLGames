...
from ws.RLUtils.monitoring.graphing.subplot_mgt import subplot_mgr

def plot_mgr(title_prefix, x_axis_label, y_info_list,subplot_width = 6.4, subplot_height = 4.8):
    ...
    for i in range(num_axes):
        ...
        fn_plot_for_specific_axis = subplot_mgr(plt, _axes[i], graph_color)
