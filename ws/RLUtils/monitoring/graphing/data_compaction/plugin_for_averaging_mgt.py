...
from ws.RLUtils.monitoring.graphing.data_compaction.compaction_mgt import compaction_mgr


def plugin_for_averaging_mgr():
    _median_xindex = None
    ...
    fn_compress_stream_data = compaction_mgr(fn_compute_xindex, fn_compute_yval)
