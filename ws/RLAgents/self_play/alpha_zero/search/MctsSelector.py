...
def MctsSelector(game, nnet, args):
    ...
    mtcs_selector_mgr = namedtuple('_', ['fn_get_action_probabilities'])
    mtcs_selector_mgr.fn_get_action_probabilities=fn_get_action_probabilities

    return mtcs_selector_mgr
