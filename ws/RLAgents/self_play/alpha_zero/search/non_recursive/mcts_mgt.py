...
def mcts_mgt(
    ...
    def fn_rollout(cache_mgr, fn_get_state_key,
                   fn_get_normalized_predictions, fn_get_next_state, fn_get_canonical_form,
                   fn_terminal_value,
                   state):
    ...
    def fn_execute_monte_carlo_tree_search(state):
        ...
        score, terminal_state = fn_rollout(cache_mgr, fn_get_state_key,
            fn_get_normalized_predictions, fn_get_next_state, fn_get_canonical_form, fn_terminal_value,
            state)
